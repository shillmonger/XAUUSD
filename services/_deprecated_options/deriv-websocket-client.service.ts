/**
 * DEPRECATED: Deriv Options WebSocket Client Service
 * 
 * This service is DEPRECATED and should NOT be used for MT5/CFD trading.
 * It was designed for Deriv Options/Multipliers trading only.
 * 
 * For MT5/CFD trading, use the MT5 execution architecture instead:
 * - mt5-execution.service.ts
 * - mt5-adapter.service.ts
 * - deriv-mt5.service.ts
 * 
