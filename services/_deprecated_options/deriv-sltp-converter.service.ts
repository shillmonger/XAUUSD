/**
 * DEPRECATED: Deriv SL/TP Converter Service
 * 
 * This service is DEPRECATED and should NOT be used for MT5/CFD trading.
 * It was designed for Deriv Options/Multipliers SL/TP conversion only.
 * 
 * For MT5/CFD trading, SL/TP are standard price-based levels directly.
 * No conversion is needed for MT5 - use the price levels directly.
 * 
