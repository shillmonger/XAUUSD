  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        toast.success(
          isEditMode
            ? "Stop loss rule updated successfully"
            : "Stop loss rule created successfully"
        );
        handleCancelEdit();
        fetchStopLossRules();
      } else {
                    ...
                    >
                      ...
                      <div className="flex items-center gap-4">
                        <div>
                          ...
                          <p className="text-sm font-mono">{rule.stop_loss}</p>
                        </div>
                      </div>
            ...
            >
              <div className="px-4 sm:px-6 py-6 space-y-6">
                ...
                <div className="p-4 bg-zinc-50 text-zinc-950 border border-border/50 rounded-xl dark:bg-zinc-900/50 dark:text-zinc-50">
                  ...
                  <p className="text-sm font-mono">{selectedRule.stop_loss}</p>
                </div>
